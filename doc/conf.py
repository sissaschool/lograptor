# -*- coding: utf-8 -*-
#
# lograptor documentation build configuration file, created by
...
# Extend Sphinx to include only docstrings for module data objects:
# Thanks to: https://stackoverflow.com/a/7832437/1838607
from sphinx.ext import autodoc

class DataDocsonlyDocumenter(autodoc.DataDocumenter):
    """
...
def setup(app):
    app.add_autodocumenter(DataDocsonlyDocumenter)
...
htmlhelp_basename = 'lograptordoc'
...
# latex_use_parts = True # Deprecated since v1.4
...
epub_publisher = u'SISSA'
epub_copyright = u'2012-2017, SISSA'
