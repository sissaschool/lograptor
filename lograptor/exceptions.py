...
class LogRaptorException(Exception):
    """Base class for exceptions generated by this package."""
...
class LogRaptorArgumentError(LogRaptorException):
    def __init__(self, argument=None, message=None):
        if message is None:
            message = f'syntax error for argument {argument!r}'
        else:
            message = f'argument {argument}: {message}'
        super().__init__(message)
...
class LogRaptorOptionError(LogRaptorException):
    ...
    def __init__(self, option, message=None):
        if message is None:
            message = f'syntax error for option {option!r}'
        else:
            message = f'option {option!r}: {message}'
        super().__init__(message)
